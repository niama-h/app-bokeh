...
p1 = figure(title="Taux de chômage par durée de chômage et année(National)", height=300, width=600,x_axis_label='Year', y_axis_label='Total')
...
#Visualisation 2
p2 = figure(x_range=years, height=300, width=500, title="Taux de chômage de moins de 12 mois par sexe pour chaque année",
...
p3 = figure(x_range=years, height=300, width=600, title="Taux de chômage de plus de 60 mois par sexe pour chaque année",
           toolbar_location=None, tools="")
...
#Visualisation 4
p4 = figure(height=300, width=300, title="Pourcentage de chômage par milieu de résidence en 2020", toolbar_location=None,
...
#Visualisation 5
p5 = figure(height=400, width=600, title="Pourcentage de chômage par diplôme en 1999(National)", toolbar_location=None,
...
#Visualisation 6
p6 = figure(height=300, width=500, title="Comparaison du taux de chômage pour 2010 et 2020(National)",
...
#Visualisation 7
p7 = figure(title="Taux d'activité par secteur pour chaque année", height=350, width=500, x_axis_label='Year', y_axis_label='Value')
...
#Visualisation 8
p8 = figure(height=350, width=500,x_range=years, title="Taux d'activité par secteur pour chaque année (Bar plot)", x_axis_label='Year', y_axis_label='Value')
...
p9 = figure(x_range=list(x), y_range=list(y[::-1]), height=300, width=600,
           title="Taux de chômage par acquisition du diplôme(rural-urbain)", toolbar_location=None, tools="hover", tooltips=[("value", "@values")])
